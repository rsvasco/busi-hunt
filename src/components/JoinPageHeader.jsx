...
import joinBg from "../assets/hero3.png"; // change image path

export default function JoinPageHeader() {
  return (
    <section className="relative min-h-[55vh] md:min-h-[65vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-10 text-center">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight mb-6 leading-tight -mt-10"
        >
          Join BusiHunt
        </motion.h1>
        ...
        >
          Become part of a thriving business community where entrepreneurs,
          professionals, and leaders connect, collaborate, and grow together
          through meaningful networking opportunities.
        </motion.p>
      </div>
    </section>
  );
